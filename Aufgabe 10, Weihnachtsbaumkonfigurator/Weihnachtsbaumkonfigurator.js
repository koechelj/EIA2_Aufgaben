    ...
    function createElements() {
        ...
        for (let i = 0; i < Aufgabe10.bestellung.length; i++) {
            ...
            if (Aufgabe10.bestellung[i].art == "Baumschmuck") {
                var checkboxBS = document.createElement("input"); //Variable: Input-Element als Platzhalter
                ...
                var labelBS = document.createElement("label"); //Variable: Titel-Element
                //bef�llen
                labelBS.id = "label2." + i;
        ...
        name = document.createElement("input"); //Input-Element f�r Namen generieren
        name.type = "text";
        name.name = "DatenName";
        ...
        submit.addEventListener("mousedown", clickButton); //Bei click Event soll function clickButton ausgef�hrt werden
